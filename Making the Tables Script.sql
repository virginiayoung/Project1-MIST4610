...
-- -----------------------------------------------------
-- Table `cs_ajr70185`.`Awards`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cs_ajr70185`.`Awards` (
...
CREATE TABLE IF NOT EXISTS `cs_ajr70185`.`Movie` (
  ...
  INDEX `fk_Movie_Awards1_idx` (`idAwards` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Movie_Genre1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Movie_Awards1`
    FOREIGN KEY (`idAwards`)
    REFERENCES `cs_ajr70185`.`Awards` (`idAwards`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cs_ajr70185`.`Reviews` (
  ...
  `reviewerRating` VARCHAR(45) NULL,
